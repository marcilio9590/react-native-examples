...
class App extends Component {
  ...
  openCokie() {
    let sortNumber = Math.floor(Math.random() * this.frases.length)
    this.setState({
      textoFrase: '"' + this.frases[sortNumber] + '"',
      image: require('./src/assets/open.png')
    })
  }
  ...
  constructor(props) {
    ...
    this.state = {
      image: require('./src/assets/close.png'),
      textoFrase: ''
    }

    this.openCokie = this.openCokie.bind(this);
  ...
  render() {
    return (
      <View style={styles.container} >
        ...
        <TouchableOpacity style={styles.button} onPress={this.openCokie}>
